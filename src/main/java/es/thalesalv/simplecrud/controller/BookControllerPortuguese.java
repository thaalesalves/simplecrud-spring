...
public class BookControllerPortuguese {

    private final BookRepository repo;
    private static final String BOOK_NOT_FOUND = "Opa! Livro não encontrado :: ";

    @GetMapping
    public Map<String, String> olaMundo() throws BookNotFound {
        Map<String, String> map = new HashMap<>();
        map.put("MENSAGEM", System.getenv("HELLO_WORLD"));
        map.put("O OpenShift é muito ", System.getenv("OPENSHIFT"));
        map.put("Mensagem para os espectadores: ", System.getenv("MESSAGE"));
